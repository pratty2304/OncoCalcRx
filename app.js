...
const protocolDatabase = {
    breast: {
        ...
        'triple_negative': {
            ...
            'Single-Nab-Paclitaxel-3weekly': {
                name: 'Nab-paclitaxel (3-weekly) (Metastatic)',
                cycles: 6,
                drugs: [
                    { name: 'Nab-paclitaxel', dose: 260, unit: 'mg/m²', schedule: 'D1, every 21 days' }
                ]
            ...
            'Single-Nab-Paclitaxel-weekly': {
                name: 'Nab-paclitaxel (weekly) (Metastatic)',
                cycles: 12,
                drugs: [
                    { name: 'Nab-paclitaxel', dose: 100, unit: 'mg/m²', schedule: 'weekly' }
                ]
    ...
    carcinoma_unknown_primary: {
        ...
        'Gemcitabine-Cisplatin': {
            name: 'Gemcitabine + Cisplatin (GC) - Adenocarcinoma/Squamous',
            cycles: 6,
            drugs: [
                { name: 'Gemcitabine', dose: 1000, unit: 'mg/m²', schedule: 'D1, D8, every 21 days' },
                { name: 'Cisplatin', dose: 75, unit: 'mg/m²', schedule: 'D1, every 21 days' }
    ...
    colorectal: {
        ...
        metastatic_colorectal: {
            ...
            'Cetuximab-Single': {
                name: 'Cetuximab (/ KRAS/NRAS/BRAF WT)',
                cycles: 8,
                drugs: [
                    { name: 'Cetuximab', dose: 400, maintenanceDose: 250, unit: 'mg/m²', schedule: 'weekly (loading dose 400 mg/m², then 250 mg/m²)', hasLoadingDose: true }
                ]
            ...
            'Panitumumab-Single': {
                name: 'Panitumumab (/ KRAS/NRAS/BRAF WT)',
                cycles: 8,
                drugs: [
                    { name: 'Panitumumab', dose: 6, unit: 'mg/kg', schedule: 'D1, every 14 days' }
                ]
    ...
    leukemia: {
        ...
        cll: {
            ...
            'Pentostatin': {
                ...
                cycles: 6,
                drugs: [
                    { name: 'Pentostatin', dose: 4, unit: 'mg/m²', schedule: 'every 14 days' }
                ]
            },
            'Bendamustine': {
    ...
    lung: {
        nsclc: {
            ...
            'Ramucirumab-Erlotinib': {
                ...
                cycles: 12,
                drugs: [
                    { name: 'Ramucirumab', dose: 10, unit: 'mg/kg', schedule: 'every 14 days' },
            ...
            'Nivolumab-Monotherapy': {
                ...
                cycles: 12,
                drugs: [
                    { name: 'Nivolumab', dose: 240, unit: 'mg', schedule: 'every 14 days' }
                ]
            },
            // ALK/ROS1 inhibitors
            'Crizotinib': {
